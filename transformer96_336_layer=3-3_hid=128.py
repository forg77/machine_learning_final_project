...
for _ in range(EPOCH):
    ...
    for i in range(0,train_size,BATCH_SIZE):
        ...
        train_input_tgt = train_set[i:upper,:,95:95+336]
        train_set_fin = train_set[i:upper,:,96:upper_bound_336+1]
    ...
    with torch.no_grad():
        for i in range(0,val_size,BATCH_SIZE):
            ...
            val_input_tgt = val_set[i:upper,:,95:95+336]
            val_set_fin = val_set[i:upper,:,96:upper_bound_336+1]
    ...
    if val_ave_loss < 0.65:
        if val_ave_loss < nowbest:
            ...
            torch.save(exp.state_dict(), 'Final_Rn_earlystop_transformer_model_dim_128_336_batch_32_lr_1e-5_epoch=50.pth')
...
torch.save(exp.state_dict(), 'Final_Rn_transformer_model_dim_128_336_batch_32_lr_1e-5_epoch=50.pth')
